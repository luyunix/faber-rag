...
class LLMReranker(BaseReranker):
    ...
    def _parse_llm_response(self, response_text: str) -> List[Dict[str, Any]]:
        ...
        """
        # 尝试 to extract JSON from response (LLM might wrap in markdown)
    ...
    def _map_results_to_candidates(
        ...
        """
        # 创建 mapping from id to candidate
        id_to_candidate = {}
        for i, candidate in enumerate(candidates):
        ...
        for result in parsed_results:
            ...
            if passage_id in id_to_candidate:
                ...
                # 更新 score with LLM rerank score
    ...
    def rerank(
        ...
        **kwargs: Any,
        ...
        # 如果 only one candidate, no need to rerank
        if len(candidates) == 1:
            return candidates
        ...
        try:
            ...
            # 返回 fallback signal - let upstream decide how to handle
        ...
        # 映射 back to candidates and sort
        try:
