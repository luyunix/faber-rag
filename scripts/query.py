#!/usr/bin/env python
"""Query script for the Faber RAG.
...
Usage:
    # 运行 a single query    python scripts/query.py --query "Azure OpenAI 配置步骤" --collection technical_docs

    # Verbose mode (show dense/sparse/fusion/rerank results)    python scripts/query.py --query "RRF 是什么" --verbose

    # Disable reranking    python scripts/query.py --query "RRF 是什么" --no-rerank
